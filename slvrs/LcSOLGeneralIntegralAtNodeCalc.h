/**
 * @file	LcSOLGeneralIntegralAtNodeCalc.h
 *
 * @brief	Compute an integral at each node in configuration space using a (v,mu) integration
 */

#ifndef LC_SOL_GENERAL_INTEGRAL_AT_NODE_CALC_H
#define LC_SOL_GENERAL_INTEGRAL_AT_NODE_CALC_H
 ...
 */
  class SOLGeneralIntegralAtNodeCalc : public Lucee::UpdaterIfc
  {
    public:
...
#endif // LC_SOL_GENERAL_INTEGRAL_AT_NODE_CALC_H
