/**
 * @file	LcImplicitHyperTwentyMomentSrcUpdater.h
 *
 * @brief	Implicit updater for 20-moment source terms
 */

#ifndef LC_IMPLICIT_HYPER_TWENTY_MOMENT_SRC_UPDATER_H
#define LC_IMPLICIT_HYPER_TWENTY_MOMENT_SRC_UPDATER_H
...
{
/**
 * Update multi-fluid 20-moment sources using an implicit method. This
 * removes the time-step restriction from plasma- and
 * cyclotron-frequency.
 */
  template <unsigned NDIM>
  class ImplicitHyperTwentyMomentSrcUpdater : public Lucee::UpdaterIfc
  {
    public:
...
#endif // LC_IMPLICIT_TWENTY_MOMENT_SRC_UPDATER_H
