/**
 * @file	LcElectromagneticAUpdater.h
 *
 * @brief	Updater to compute A_parallel use inputs calculated in x-p space
 */

#ifndef LC_ELECTROMAGNETIC_A_UPDATER_H
#define LC_ELECTROMAGNETIC_A_UPDATER_H
 ...
 * Galerkin scheme.
 */
  class ElectromagneticAUpdater : public Lucee::UpdaterIfc
  {
    public:
...
#endif // LC_ELECTROMAGNETIC_A_UPDATER_H
