/**
 * @file	LcEvalOnBoundaryNodesUpdater.h
 *
 * @brief	Evaluate function on nodal field.
 */

#ifndef LC_EVAL_ON_BOUNDARY_NODES_UPDATER_H
#define LC_EVAL_ON_BOUNDARY_NODES_UPDATER_H
 ...
 */
  ...
  class EvalOnBoundaryNodesUpdater : public Lucee::UpdaterIfc
  {
    public:
...
#endif // LC_EVAL_ON_BOUNDARY_NODES_UPDATER_H
