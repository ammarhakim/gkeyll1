/**
 * @file	LcKineticEnergyUpdater.h
 *
 * @brief Updater to compute energy using discrete hamiltonian and distribution function
 */

#ifndef LC_KINETIC_ENERGY_UPDATER_H
#define LC_KINETIC_ENERGY_UPDATER_H
 ...
 * Galerkin scheme.
 */
  class KineticEnergyUpdater : public Lucee::UpdaterIfc
  {
    public:
...
#endif // LC_KINETIC_ENERGY_UPDATER_H
