/**
 * @file	LcPositivityUpdater.h
 *
 * @brief	Updater to enforce positivity preservation.
 */

#ifndef LC_POSITIVITY_UPDATER_H
#define LC_POSITIVITY_UPDATER_H
 ...
 * Galerkin scheme.
 */
  class PositivityUpdater : public Lucee::UpdaterIfc
  {
    public:
