/**
 * @file	LcImplicitTwentyMomentSrcUpdater.h
 *
 * @brief	Implicit updater for 20-moment source terms
 */

#ifndef LC_IMPLICIT_TWENTY_MOMENT_SRC_UPDATER_H
#define LC_IMPLICIT_TWENTY_MOMENT_SRC_UPDATER_H
 ...
 */
  ...
  class ImplicitTwentyMomentSrcUpdater : public Lucee::UpdaterIfc
  {
    public:
