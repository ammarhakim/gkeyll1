/**
 * @file	LcSOLPositivityDragSliceInMuUpdater.h
 *
 * @brief	Updater used to adjust energy at each node by use of a drag term that acts on a 1d slice
 */

#ifndef LC_SOL_POSITIVITY_DRAG_SLICE_IN_MU_UPDATER_H
#define LC_SOL_POSITIVITY_DRAG_SLICE_IN_MU_UPDATER_H
 ...
 */
  class SOLPositivityDragSliceInMuUpdater : public Lucee::UpdaterIfc
  {
    public:
...
/** Create new projection updater */
      SOLPositivityDragSliceInMuUpdater();
...
#endif // LC_SOL_POSITIVITY_DRAG_SLICE_IN_MU_UPDATER_H
