 ...
 */
#ifndef LC_HYPER_TWENTY_MOMENT_EQUATION_H
#define LC_HYPER_TWENTY_MOMENT_EQUATION_H
...
class HyperTwentyMomentEquation : public Lucee::HyperEquation
{
public:
...
/** Enum for closure types */
      enum Closure { CL_GAUSS, CL_TAIL, CL_MAX };
...
#endif // LC_TWENTY_HYPER_MOMENT_EQUATION_H
