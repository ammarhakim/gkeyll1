/**
 * @file	LcHeatFluxAtEdge3DUpdater.h
 *
 * @brief	Updater to compute heat flux at right-most edge in domain for the 3D SOL problem.
 */

#ifndef LC_HEAT_FLUX_AT_EDGE_3D_UPDATER_H
#define LC_HEAT_FLUX_AT_EDGE_3D_UPDATER_H
 ...
 * Galerkin scheme.
 */
  class HeatFluxAtEdge3DUpdater : public Lucee::UpdaterIfc
  {
    public:
...
#endif // LC_HEAT_FLUX_AT_EDGE_3D_UPDATER_H
