/**
 * @file	LcLenardBernsteinDrag3D2VUpdater.cpp
 *
...
// set id for module system
  const char *LenardBernsteinDrag3D2VUpdater::id = "LenardBernsteinDrag3D2VUpdater";

  LenardBernsteinDrag3D2VUpdater::LenardBernsteinDrag3D2VUpdater()
    : UpdaterIfc()
  {
  }

  void 
  LenardBernsteinDrag3D2VUpdater::readInput(Lucee::LuaTable& tbl)
  {
    ...
    if (tbl.hasObject<Lucee::NodalFiniteElementIfc<5> >("basis5d"))
      ...
      throw Lucee::Except("LenardBernsteinDrag3D2VUpdater::readInput: Must specify element to use using 'basis5d'");
    ...
    if (tbl.hasObject<Lucee::NodalFiniteElementIfc<3> >("basis3d"))
      ...
      throw Lucee::Except("LenardBernsteinDrag3D2VUpdater::readInput: Must specify element to use using 'basis3d'");
    ...
    if (tbl.hasObject<Lucee::NodalFiniteElementIfc<2> >("basis2d"))
      ...
      throw Lucee::Except("LenardBernsteinDrag3D2VUpdater::readInput: Must specify element to use using 'basis2d'");
    ...
    if (tbl.hasFunction("alpha"))
      ...
      throw Lucee::Except("LenardBernsteinDrag3D2VUpdater::readInput: Must supply a collision frequency function as alpha.");
  }

  void 
  LenardBernsteinDrag3D2VUpdater::initialize()
  {
  ...
  Lucee::UpdaterStatus 
  LenardBernsteinDrag3D2VUpdater::update(double t)
  {
    const Lucee::StructuredGridBase<5>& grid
      = this->getGrid<Lucee::StructuredGridBase<5> >();
  ...
  void
  LenardBernsteinDrag3D2VUpdater::declareTypes()
  {
  ...
  void
  LenardBernsteinDrag3D2VUpdater::copyLuceeToEigen(const Lucee::Matrix<double>& sourceMatrix,
  ...
  void
  LenardBernsteinDrag3D2VUpdater::evaluateFunction(Lucee::LuaState& L, double tm,
    std::vector<double>& res)
  {
    ...
    {
      Lucee::Except lce("LenardBernsteinDrag3D2VUpdater::evaluateFunction: ");
    ...
    {
      if (!lua_isnumber(L, i))
        throw Lucee::Except("LenardBernsteinDrag3D2VUpdater::evaluateFunction: Return value not a number");
  ...
  bool
  LenardBernsteinDrag3D2VUpdater::sameConfigCoords(int srcIndex, int tarIndex, double dxMin,
