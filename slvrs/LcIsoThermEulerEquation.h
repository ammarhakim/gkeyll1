/**
 * @file	LcIsoThermEulerEquation.h
 *
 * @brief	Euler equations for gas-dynamics.
 */
#ifndef LC_ISO_THERMAL_EULER_EQUATION_H
#define LC_ISO_THERMAL_EULER_EQUATION_H
 ...
 */
  class IsoThermEulerEquation : public Lucee::HyperEquation
  {
    public:
...
#endif //  LC_ISO_THERMAL_EULER_EQUATION_H
