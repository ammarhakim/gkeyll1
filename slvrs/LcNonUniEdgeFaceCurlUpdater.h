/**
 * @file	LcNonUniEdgeFaceCurlUpdater.h
 *
 * @brief	Compute curl on rectangular grids.
 */

#ifndef LC_NON_UNI_EDGE_FACE_CURL_UPDATER_H
#define LC_NON_UNI_EDGE_FACE_CURL_UPDATER_H
 ...
 */
  ...
  class NonUniEdgeFaceCurlUpdater : public Lucee::UpdaterIfc
  {
    public:
...
/** minimum grid spacing of non-uniform grid */
      double dxMin[3];
  };
}
