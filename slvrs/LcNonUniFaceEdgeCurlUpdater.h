/**
 * @file	LcNonUniFaceEdgeCurlUpdater.h
 *
 * @brief	Compute curl on rectangular grids.
 */

#ifndef LC_NON_UNI_FACE_EDGE_CURL_UPDATER_H
#define LC_NON_UNI_FACE_EDGE_CURL_UPDATER_H
 ...
 */
  ...
  class NonUniFaceEdgeCurlUpdater : public Lucee::UpdaterIfc
  {
    public:
