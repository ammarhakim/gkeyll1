/**
 * @file        LcAuxAdvectionEquation.h
 *
 * @brief	Advection with velocity specified in auxiliary variable.
 */
#ifndef LC_AUX_ADVECTION_EQUATION_H
#define LC_AUX_ADVECTION_EQUATION_H
 ...
 */
  ...
  class AuxAdvectionEquation : public Lucee::HyperEquation
  {
    public:
...
#endif //  LC_AUX_ADVECTION_EQUATION_H
