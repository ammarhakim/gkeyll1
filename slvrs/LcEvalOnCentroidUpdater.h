/**
 * @file	LcEvalOnCentroidUpdater.h
 *
 * @brief	Evaluate function on nodal field.
 */

#ifndef LC_EVAL_ON_CENTROID_UPDATER_H
#define LC_EVAL_ON_CENTROID_UPDATER_H
 ...
 */
  ...
  class EvalOnCentroidUpdater : public Lucee::UpdaterIfc
  {
 ...
 * @param nc Centroid nodal cooridates.
...
#endif // LC_EVAL_ON_CENTROID_UPDATER_H
