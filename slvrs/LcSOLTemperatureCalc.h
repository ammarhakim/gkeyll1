/**
 * @file  LcSOLTemperatureCalc.h
 *
 * @brief	Simple updater to compute temperature node-by-node for 5D SOL simulations
 */

#ifndef LC_SOL_TEMPERATURE_CALC
#define LC_SOL_TEMPERATURE_CALC
 ...
 */
  class SOLTemperatureCalc : public Lucee::UpdaterIfc
  {
    public:
