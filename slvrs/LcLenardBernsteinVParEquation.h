/**
 * @file        LcLenardBernsteinVParEquation.h
 *
 * @brief	Lenard-Bernstein collision operator in v_parallel
 */

#ifndef LC_LENARD_BENSTEIN_VPAR_EQUATION_H
#define LC_LENARD_BENSTEIN_VPAR_EQUATION_H
...
{
/**
 * Represents the Lenard-Bernstein collision operator as an auxillary
 * equation .
 */
  class LenardBernsteinVParEquation : public Lucee::HyperEquation
  {
    public:
...
#endif //  LC_LENARD_BENSTEIN_VPAR_EQUATION_H
