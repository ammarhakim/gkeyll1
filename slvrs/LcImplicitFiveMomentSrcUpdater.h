/**
 * @file	LcImplicitFiveMomentSrcUpdater.h
 *
 * @brief	Implicit updater for 5-moment source terms
 */

#ifndef LC_IMPLICIT_FIVE_MOMENT_SRC_UPDATER_H
#define LC_IMPLICIT_FIVE_MOMENT_SRC_UPDATER_H
 ...
 */
  ...
  class ImplicitFiveMomentSrcUpdater : public Lucee::UpdaterIfc
  {
    public:
