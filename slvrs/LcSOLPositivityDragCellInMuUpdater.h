/**
 * @file	LcSOLPositivityDragCellInMuUpdater.h
 *
 * @brief	Updater used to adjust energy at each cell by use of a drag term
 */

#ifndef LC_SOL_POSITIVITY_DRAG_CELL_IN_MU_UPDATER_H
#define LC_SOL_POSITIVITY_DRAG_CELL_IN_MU_UPDATER_H
 ...
 */
  class SOLPositivityDragCellInMuUpdater : public Lucee::UpdaterIfc
  {
    public:
...
/** Create new projection updater */
      SOLPositivityDragCellInMuUpdater();
...
#endif // LC_SOL_POSITIVITY_DRAG_CELL_IN_MU_UPDATER_H
