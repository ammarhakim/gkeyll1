/**
 * @file	LcProjectOnNodalBasisUpdater.h
 *
 * @brief	Evaluate function on nodal field.
 */

#ifndef LC_PROJECT_ON_NODAL_BASIS_UPDATER_H
#define LC_PROJECT_ON_NODAL_BASIS_UPDATER_H
 ...
 */
  ...
  class ProjectOnNodalBasisUpdater : public Lucee::UpdaterIfc
  {
    public:
...
#endif // LC_PROJECT_ON_NODAL_BASIS_UPDATER_H
