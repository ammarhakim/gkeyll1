/**
 * @file	LcSOLWeightedProjectionCalc.h
 *
 * @brief	Projects the product of B*g*f onto a 3d field, where g and f are 5d fields and g is a 3d field
 */

#ifndef LC_SOL_WEIGHTED_PROJECTION_CALC_H
#define LC_SOL_WEIGHTED_PROJECTION_CALC_H
 ...
 */
  class SOLWeightedProjectionCalc : public Lucee::UpdaterIfc
  {
    public:
...
/** Create new projection updater */
      SOLWeightedProjectionCalc();
/**  Destructor */
      virtual ~SOLWeightedProjectionCalc();
...
#endif // LC_SOL_WEIGHTED_PROJECTION_CALC_H
