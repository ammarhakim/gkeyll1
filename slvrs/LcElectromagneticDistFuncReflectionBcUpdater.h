...
#ifndef LC_ELECTROMAGNETIC_DIST_FUNC_REFLECTION_BC_UPDATER_H
#define LC_ELECTROMAGNETIC_DIST_FUNC_REFLECTION_BC_UPDATER_H
 ...
 */
  class ElectromagneticDistFuncReflectionBcUpdater : public Lucee::UpdaterIfc
  {
    public:
...
/** Create new projection updater */
      ElectromagneticDistFuncReflectionBcUpdater();
 ...
 */
      ...
      double findRightCutoffVelocity(const Lucee::ConstFieldPtr<double>& searchFld, const double initialGuess,
        const double exactResult, const double cellWidth, const double* cellCentroid, const double aAtEdge,
        const double tol);
...
#endif // LC_ELECTROMAGNETIC_DIST_FUNC_REFLECTION_BC_UPDATER_H
