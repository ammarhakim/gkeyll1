/**
 * @file        LcGradEquation.h
 *
 * @brief	Gradient of flux specifed as auxillary variable.
 */
#ifndef LC_GRAD_AUX_EQUATION_H
#define LC_GRAD_AUX_EQUATION_H
...
{
/**
 * Represents an hyperbolic equation which is gradient of a flux
