/**
 * @file	LcElectromagneticAForcingUpdater.h
 *
 * @brief	Updater to compute A_parallel use inputs calculated in x-p space
 */

#ifndef LC_ELECTROMAGNETIC_A_FORCING_UPDATER_H
#define LC_ELECTROMAGNETIC_A_FORCING_UPDATER_H
 ...
 * Galerkin scheme.
 */
  class ElectromagneticAForcingUpdater : public Lucee::UpdaterIfc
  {
    public:
...
/** Create new nodal DG solver */
      ElectromagneticAForcingUpdater();
...
#endif // LC_ELECTROMAGNETIC_A_FORCING_UPDATER_H
