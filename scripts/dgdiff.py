...
pylab.plot(Xc, q0/dx2, '-m')
pylab.plot(Xc, 2/dx*q1d/dx2, '--b', Xc, D3fx(Xc), 'or')
pylab.axis('tight')
...
pylab.plot(Xc, 2/dx*q1s/dx2, '--b', Xc, D3fx(Xc), 'or')
pylab.axis('tight')
...
pylab.plot(Xc, 2/dx*q1i/dx2, '--b', Xc, D3fx(Xc), 'or')
...
pylab.plot(Xc, 2/dx*q1dd/dx2, '--b', Xc, D3fx(Xc), 'or')
