 ...
 * @return node for the file.
 */
      virtual Lucee::IoNodeType openFile(const std::string& fileName, const std::string& perms) = 0;
 ...
 */
      virtual Lucee::IoNodeType createGroup(Lucee::IoNodeType node, const std::string& dataName) const = 0;
 ...
 */
      virtual Lucee::IoNodeType openGroup(Lucee::IoNodeType node, const std::string& dataName) const = 0;
 ...
 */
      virtual Lucee::IoNodeType createDataSet(Lucee::IoNodeType node, const std::string& dataName) const = 0;
 ...
 * @return the node to the read data
 */
      virtual Lucee::IoNodeType openDataSet(Lucee::IoNodeType node, const std::string& dataName) const = 0;
