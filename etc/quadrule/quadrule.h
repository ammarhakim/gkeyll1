...
// This code is taken verbatim from the QUADRULE website. QUADRULE is
// under the LGPL licence. I have just added the double inclusion
// trap. (Ammar Hakim, November 6th 2012).
