...
#ifndef LCWRITE_CGNS_HPP
#define LCWRITE_CGNS_HPP
...
class LcWriteCGNS : public WriterIface
{
...
public:
  ...
  // Get the CGNSType
  ErrorCode get_cgns_type ( int i, std::vector<LcWriteCGNS::SetStruct> &Sets );
