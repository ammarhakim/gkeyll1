/**
 * @file	LcPeriodicParallelPoisson2DUpdater.h
 *
 * @brief	Updater to solve Poisson equations with periodic BCs
 */

#ifndef LC_PERIODIC_PARALLEL_POISSON_2D_UPDATER_H
#define LC_PERIODIC_PARALLEL_POISSON_2D_UPDATER_H
 ...
 */
  class PeriodicParallelPoisson2DUpdater : public Lucee::UpdaterIfc
  {
    public:
 ...
 * Create new updater.
 */
      PeriodicParallelPoisson2DUpdater();
