/**
 * @file	LcScalingPositivityLimiterAlphaV.h
 *
 * @brief	Updater for initializing the Maxwellian distribution from moments
 */

#ifndef LC_SCALING_POSITIVITY_LIMITER_ALPHAV_H
#define LC_SCALING_POSITIVITY_LIMITER_ALPHAV_H
 ...
 */
  ...
  class ScalingPositivityLimiterAlphaV : public Lucee::UpdaterIfc
  {
    ...
    public:
      ...
      /** Constructor */
      ScalingPositivityLimiterAlphaV();
      /** Destructor */
      virtual ~ScalingPositivityLimiterAlphaV();
...
#endif // LC_SCALING_POSITIVITY_LIMITER_ALPHAV_H
