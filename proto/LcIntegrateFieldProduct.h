/**
 * @file	LcIntegrateFieldProduct.h
 *
 * @brief	Updater to integrate the product of two DG fields on the same basis set over the entire domain.
 */

#ifndef LC_INTEGRATE_FIELD_PRODUCT_H
#define LC_INTEGRATE_FIELD_PRODUCT_H
 ...
 */
  ...
  class IntegrateFieldProduct : public Lucee::UpdaterIfc
  {
    public:
...
#endif // LC_INTEGRATE_FIELD_PRODUCT_H
