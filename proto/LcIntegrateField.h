/**
 * @file	LcIntegrateField.h
 *
 * @brief	Updater to integrate a field along a specified line.
 */

#ifndef LC_INTEGRATE_FIELD_H
#define LC_INTEGRATE_FIELD_H
...
{
/**
 * Updater to integrate field on a domain.
 */
  template <unsigned NDIM>
  class IntegrateField : public Lucee::UpdaterIfc
  {
    public:
