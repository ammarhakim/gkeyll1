/**
 * @file	LcPeriodicPoisson2DUpdater.h
 *
 * @brief	Updater to solve Poisson equations with periodic BCs
 */

#ifndef LC_PERIODIC_POISSON_2D_UPDATER_H
#define LC_PERIODIC_POISSON_2D_UPDATER_H
 ...
 */
  class PeriodicPoisson2DUpdater : public Lucee::UpdaterIfc
  {
    public:
