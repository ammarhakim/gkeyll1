/**
 * @file	LcRectSecondOrderCentralDiffUpdater.h
 *
 * @brief	Compute 2nd order central-differences on a rectangular grid.
 */

#ifndef LC_RECT_SECOND_ORDER_CENTRAL_DIFF_UPDATER_H
#define LC_RECT_SECOND_ORDER_CENTRAL_DIFF_UPDATER_H
 ...
 */
  ...
  class RectSecondOrderCentralDiffUpdater : public Lucee::UpdaterIfc
  {
    public:
 ...
 */
      RectSecondOrderCentralDiffUpdater();
