/**
 * @file	LcPoissonBracketSimpleOldUpdater.h
 *
...
#ifndef LC_POISSON_BRACKET_SIMPLE_OLD_UPDATER_H
#define LC_POISSON_BRACKET_SIMPLE_OLD_UPDATER_H
...
namespace Lucee
{
  ...
  class PoissonBracketSimpleOldUpdater : public Lucee::UpdaterIfc
  {
    public:
...
/** Create new nodal DG solver */
      PoissonBracketSimpleOldUpdater();
...
#endif // LC_POISSON_BRACKET_SIMPLE_OLD_UPDATER_H
