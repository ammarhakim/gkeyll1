/**
 * @file	LcPoissonBracketSimpleUpdater.h
 *
...
#ifndef LC_POISSON_BRACKET_SIMPLE_UPDATER_H
#define LC_POISSON_BRACKET_SIMPLE_UPDATER_H
...
namespace Lucee
{
  ...
  class PoissonBracketSimpleUpdater : public Lucee::UpdaterIfc
  {
    public:
...
#endif // LC_POISSON_BRACKET_SIMPLE_UPDATER_H
