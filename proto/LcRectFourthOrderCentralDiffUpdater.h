/**
 * @file	LcRectFourthOrderCentralDiffUpdater.h
 *
 * @brief	Compute 2nd order fourth central-differences derivative on a rectangular grid.
 */

#ifndef LC_RECT_FOURTH_ORDER_CENTRAL_DIFF_UPDATER_H
#define LC_RECT_FOURTH_ORDER_CENTRAL_DIFF_UPDATER_H
 ...
 */
  ...
  class RectFourthOrderCentralDiffUpdater : public Lucee::UpdaterIfc
  {
    public:
 ...
 */
      RectFourthOrderCentralDiffUpdater();
...
#endif // LC_RECT_FOURTH_ORDER_CENTRAL_DIFF_UPDATER_H
