...
#ifndef LC_ENERGY_FROM_STREAM_AND_VORT_UPDATER_H
#define LC_ENERGY_FROM_STREAM_AND_VORT_UPDATER_H
 ...
 */
  class EnergyFromStreamAndVortUpdater : public Lucee::UpdaterIfc
  {
    public:
...
/** Create new modal DG solver in 1D */
      EnergyFromStreamAndVortUpdater();
...
#endif // LC_ENERGY_FROM_STREAM_AND_VORT_UPDATER_H
