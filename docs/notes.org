...
** 14th October 2009: On reproducible research
   ...
   How would one publish reproducible research? The convectional answer
   is to give access to the code as well as the input files used to
   run simulations. Further, the scripts to make the published
   research need to be provided. However, this does not seem like a
   general solution as (a) the code may be proprietary and under
   licence agreement (b) the code may be very complex to build and run
   and may need significant effort to learn.
   
   A more general solution can be provided by a hierarchy of access to
   ...
   - Data and script to make the plots must be provided. This should
     ...
     always interested in running the code but getting access to the
     data to compare.
