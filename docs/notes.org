...
** 18th September 2009: Documentation notes. AGAIN!!
   ...
   On more thought the API documentation should be in the code and
   automatically created using doxygen. The writing of texinfo files
   duplicates the documentation that is already in the code.
