...
* May 26th
  ...
  Added a skeleton for copy BCs. These need to be completed. Then need
  to add a function BC to the StructGridField class (as it knows the
  centroid coordinates). Then need to add general "copy" BC function
  that takes an array of coefficients to multiply before copy.
