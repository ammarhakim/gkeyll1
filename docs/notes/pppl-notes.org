...
* June 11th
  ...
  revisted when generalizing the code to general geometries, specially
  for unstructured grids. It might be best to just work in general
  geometries for the production code and move the current nodal
  elements to the proto directory. [Isn't all of life a prototype for
  something "better"?]
...
** TODO Complete proof of DG energy conservation
   ...
   This required some thought on how the discontinuity in d(phi)/dx
