...
** A note on basis function
   ...
   The problem with Lobatto is that there are more basis functions
   than in the Serendipity case. However, this is perhaps okay as it
   simplifies the algorithm as well as increases solution accuracy.
...
** TODO Complete fixed-potential Vlasov journal note
   ...
   For this, need to implement moment computing updater. Several new
   matrices are needed to perform the integration.

   Also, a volume intergration updater is needed.
