...
** Notes on commenting code

   Please do not comment obvious things. For example, comment like
   "apply Bcs" before a method called "applyBc" are superfluous. Aim
   for minimum (but judicously placed) comments. 
