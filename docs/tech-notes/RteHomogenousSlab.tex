...
\begin{frame}{Initialization of algorithm}
  ...
  \item First, pick a set of $N$ quadrature points in the domain $\mu
    ...
    quadrature is used\footnote{See {\tt buildAlgorithms()}}.
...
\begin{frame}{Compute the eigensystem of the RTE: Stage 2}
  ...
  eigenvalues and eignevectors. Denote these by $\lambda_j$ and
  ...
  \gvec{\Phi}_-(\nu_j)$\footnote{See function {\tt calc\_RTE\_eigensystem()}}.
\end{frame}
% ----------------------------------------------------------------
