...
* Persoal notes
** Get first draft of website on server

   Just make something for now and worry about fixing it later.

** Put together application for the fellowship at ANL

   Need three letters, a research interest statement, abstracts of
   papers.
...
** 14th October 2009: On reproducible research
   ...
   provided. However, this does not seem like a general solution as
   (a) the code may be proprietary and under licence agreement (b) the
   code may be very complex to build and run and may need significant
   effort to learn.
...
** DONE Send Sveta slide on UEDIE proposal

   Why this is needed, what we propose to do. Maybe a figure.
